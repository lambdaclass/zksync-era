...
use zk_evm_1_5_0::{
    ...
    zkevm_opcode_defs::{
        FarCallABI, FatPointer, Opcode, RetOpcode, UMAOpcode, CALL_IMPLICIT_CALLDATA_FAT_PTR_REGISTER, RET_IMPLICIT_RETURNDATA_PARAMS_REGISTER
    },
};
...
use crate::{
    glue::GlueInto, interface::{
        tracer::VmExecutionStopReason, traits::tracers::dyn_tracers::vm_1_5_0::DynTracer,
        VmRevertReason,
    }, tracers::call_tracer::CallTracer, vm_latest::{utils::heap_page_from_base, BootloaderState, HistoryMode, SimpleMemory, VmTracer, ZkSyncVmState}
};
