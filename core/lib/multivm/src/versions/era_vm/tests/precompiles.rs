...
use crate::{
    era_vm::tests::{tester::VmTesterBuilder, utils::read_precompiles_contract},
...
fn test_keccak() {
    ...
    let keccak_count = vm.vm.inner.statistics.keccak256_cycles;
...
fn test_sha256() {
    ...
    let sha_count = vm.vm.inner.statistics.sha256_cycles;
...
fn test_ecrecover() {
    ...
    let ecrecover_count = vm.vm.inner.statistics.ecrecover_cycles;
