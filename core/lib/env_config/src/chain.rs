...
mod tests {
    ...
    fn expected_state_keeper_config(
        ...
        StateKeeperConfig {
            ...
            evm_simulator_hash: Some(hash(
                "0x01000fd17b5fd5315744973006bd6ba05e10493732584d83e8713f0921a6d7a5",
            )),
    ...
    fn state_keeper_config(l1_batch_commit_data_generator_mode: &str) -> String {
        format!(
            ...
            CHAIN_STATE_KEEPER_EVM_SIMULATOR_HASH=0x01000fd17b5fd5315744973006bd6ba05e10493732584d83e8713f0921a6d7a5
